...
function Hero (props) {
 ...
 <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
     ...
     <p class="leading-normal w-full md:text-left text-2xl mb-8">{props.description}</p>
     <a class="mx-auto md:ml-0" href="#featured_profiles"><button class=" hover:underline bg-brand-accent text-white font-bold rounded-sm my-6 py-4 px-8 shadow-2xl">{props.buttonText}</button></a>
