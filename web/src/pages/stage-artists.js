...
export const query = graphql`
  query StageArtistsPageQuery {
    categories: sanityCategory(title: {eq: "Stage Artists"}) {
    id
    title
    slug {
      current
    ...
    profiles: allSanitySampleProfile(
      ...
      filter: {categories: {elemMatch: {title: {eq: "Stage Artists"}}}}
    ) {
      edges {
        node {
          id
...
export default StageArtistsPage
