...
export const query = graphql`
  query MusicIndustryPageQuery {
    categories: sanityCategory(title: {eq: "Music Industry"}) {
    id
    title
    slug {
      current
    ...
    profiles: allSanitySampleProfile(
      ...
      filter: {categories: {elemMatch: {title: {eq: "Music Industry"}}}}
    ) {
      edges {
        node {
          id
