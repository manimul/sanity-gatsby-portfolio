...
export const query = graphql`
  query LegalPractitionersPageQuery {
    categories: sanityCategory(title: {eq: "Legal Practitioners"}) {
    id
    title
    slug {
      current
    ...
    profiles: allSanitySampleProfile(
      ...
      filter: {categories: {elemMatch: {title: {eq: "Legal Practitioners"}}}}
    ) {
      edges {
        node {
          id
...
`
const LegalPractitionersPage = props => {
...
export default LegalPractitionersPage
