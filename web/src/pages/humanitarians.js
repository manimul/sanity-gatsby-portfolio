...
export const query = graphql`
  query HumanitariansPageQuery {
    categories: sanityCategory(title: {eq: "Humanitarians"}) {
    id
    title
    slug {
      current
    ...
    profiles: allSanitySampleProfile(
      ...
      filter: {categories: {elemMatch: {title: {eq: "Humanitarians"}}}}
    ) {
      edges {
        node {
          id
...
export default HumanitariansPage
