...
export const query = graphql`
  query MovieStarsPageQuery {
    categories: sanityCategory(title: {eq: "Movie Stars"}) {
    id
    title
    slug {
      current
    ...
    profiles: allSanitySampleProfile(
      ...
      filter: {categories: {elemMatch: {title: {eq: "Movie Stars"}}}}
    ) {
      edges {
        node {
          id
